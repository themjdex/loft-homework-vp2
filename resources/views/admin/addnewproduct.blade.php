    ...
    <div class="main-wrapper">
        ...
        <div class="middle">
                ...
                <div class="sidebar-item">
                    ...
                    <div class="sidebar-item__content">
                        <ul class="sidebar-category">
                            ...
                            <li class="sidebar-category__item"><a href="/publi/public/category/1" class="sidebar-category__item__link">Стратегии</a></li>
                        </ul>
                    </div>
                </div>
                <div class="sidebar-item">
            ...
            <div class="main-content">
                ...
                <form action="./newprod" method="post" class="admin-form">
                    @csrf
                    ...
                    <label for="new-email">Описание: </label>
