        ...
        <div class="main-content">
            <div class="content-middle">
                <div class="content-main__container">
                    ...
                    <div>
                        <p>Для отправки заказа оставьте ваши данные. Наш менеджер свяжется с вами и согласует доставку.</p>
                        <form action="send" method="post" class="create-order">
                            @csrf
                            <input type="hidden" name="id" value={{ $id }}>
                            <label for="name-buyer">Ваше имя: </label>
                            <input type="text" name="name" id="name-buyer">
                            <label for="email-buyer">Ваша почта: </label>
                            <input type="text" name="email" id="email-buyer" value={{ $email }}>
                            <input type="submit" value="Заказать" class="btn-order">
                        </form>
                    </div>
                </div>
            </div>
