                ...
                <div class="sidebar-item">
                    ...
                    <div class="sidebar-item__content">
                        <ul class="sidebar-category">
                            <li class="sidebar-category__item"><a href="http://loft-vp2/public/category" class="sidebar-category__item__link">Action</a></li>
                ...
                <div class="content-middle">
                    ...
                    @foreach($games as $game)
                                <div class="products-columns__item">
                                    <div class="products-columns__item__title-product"><a href="/product/{{ $game->id }}" class="products-columns__item__title-product__link">{{ $game->name }}</a></div>
